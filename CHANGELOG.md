...
- Docs: add generated provider docs and pipeline checks
...
- Build: add linux armv6 release artifacts
- Build: fix goreleaser arm archive naming collision
...
- Feat: add gateway, tool, server, agent, and resource managed resources
- Feat: update go-contextforge sdk to v0.8.1 and enable server associations

### Fixed

- Fix: remove gpg signing and fix version calculation from git tags
...
[Unreleased]: https://github.com/leefowlercu/terraform-provider-contextforge/compare/v0.4.0...HEAD
...
[v0.3.0]: https://github.com/leefowlercu/terraform-provider-contextforge/compare/v0.2.0...v0.3.0
[v0.4.0]: https://github.com/leefowlercu/terraform-provider-contextforge/compare/v0.3.0...v0.4.0
